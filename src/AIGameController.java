...
public class AIGameController<T> implements Controller {
    ...
    public void AImove(){
    	...
    	if(board.getCurrentPlayer()==board.getPlayer1())return;
    	StandardBoard new1 = AI.clone(board); 
    	
    	Move move = AI.Minimax(new1,100,-1, 4);
    	//System.out.println(move.getX()+" "+move.getY());
    	if(move==null){System.out.println("ok null");}
    ...
    public void removeWall(int topLeftX, int topLeftY, WallPlacement orientation, int playerID) {
    		...
    		boolean wallsRemoved = board.unassignWalls(topLeft,orientation);
    		if (wallsRemoved) {
